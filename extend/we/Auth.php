    ...
    */
    ...
    public function check($name, $uid, $relation = 'or', $mode = 'url')
    {
        ...
        foreach ($rulelist as $rule)
        {
            ...
            {
                parse_str($query, $param); //解析规则中的param  parse_str() 函数把查询字符串解析到变量中[数组]
                $intersect = array_intersect_assoc($REQUEST, $param); #array_intersect_assoc() 函数用于比较两个（或更多个）数组的键名和键值，并返回交集。
        ...
        $diff = array_diff($name, $list); #array_diff() 函数返回两个数组的差集数组
