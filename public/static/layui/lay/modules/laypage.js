...
;layui.define(function (e) {
    ...
    u.prototype.type = function () {
        ...
        a.all = a.all?a.all:'共',a.item = a.item?a.item:'条',a.confirm = a.confirm?a.confirm:'确认',a.page=a.page?a.page:'页',a.ipage=a.ipage?a.ipage:'页',a.to=a.to?a.to:'到第';
        ...
        var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1, i = {
            ...
            count: '<span class="layui-laypage-count">' + a.all + a.count + a.item+ "</span>",
            limit: function () {
                var e = ['<span class="layui-laypage-limits"><select lay-ignore>'];
                return layui.each(a.limits, function (t, n) {
                    e.push('<option value="' + n + '"' + (n === a.limit ? "selected" : "") + ">" + n + " "+a.ipage+"</option>")
                }), e.join("") + "</select></span>"
            }(),
            refresh: ['<a href="javascript:;" data-page="' + a.curr + '" class="layui-laypage-refresh">', '<i class="layui-icon layui-icon-refresh"></i>', "</a>"].join(""),
            skip: function () {
                return ['<span class="layui-laypage-skip">'+a.to+' '+' <input type="text" min="1" value="' + a.curr + '" class="layui-input">'+a.page+'<button type="button" class="layui-laypage-btn">'+a.confirm+'</button>', "</span>"].join("")
            }()
        };
