...
class AfterSale extends baseAdmin{
    protected $table;
    ...
    public function med_diff_evalua(){
        return $this->view->fetch();
    }
    
    public function reminder_appraise(){
        return $this->view->fetch();
    }
    
    public function reminder_praise(){
        return $this->view->fetch();
    }
    ...
    public function reminder_warning(){
        return $this->view->fetch();
    }
